...
async function testConfiguration() {
    ...
    console.log(`   - GROQ_API_KEY: ${hasApiKey ? '✅ Définie' : '❌ Manquante'}`);
    ...
    try {
        const { default: ReactGenerator } = await import('./src/generators/react-gen.js');
        console.log('   ✅ ReactGenerator importé');
        
        const { default: CodeValidator } = await import('./src/utils/validators.js');
        console.log('   ✅ CodeValidator importé');
        
        const { default: CodeFormatter } = await import('./src/utils/formatters.js');
