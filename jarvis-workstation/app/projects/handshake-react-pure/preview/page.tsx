    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Chargement du projet Handshake...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">React Dashboard UI full frontend</p>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-glow overflow-hidden">
        <div className="border-b border-gray-200 dark:border-gray-700 p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-4 text-sm text-gray-600 dark:text-gray-400">handshake-dashboard.local:3000</span>
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="space-y-8">
            {/* Header du dashboard */}
            <div className="text-center">
              <h2 className="text-3xl font-bold text-accent-1 mb-2">Handshake Dashboard</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-accent-1/20 to-accent-1/5 p-6 rounded-2xl border border-accent-1/20">
                <div className="text-2xl font-bold text-accent-1 mb-1">1,234</div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl">
              ...
              <div className="h-64 bg-gradient-to-r from-accent-1/10 to-accent-3/10 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Recharts Graphique</p>
                  <p className="text-sm text-gray-500">Données dynamiques avec animations</p>
                </div>
              </div>
            </div>
            ...
            {/* Force Graph simulé */}
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl">
              <h3 className="text-lg font-semibold mb-4">Network Connections</h3>
              <div className="h-64 bg-gradient-to-r from-accent-2/10 to-accent-4/10 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <div className="text-4xl mb-2">🕸️</div>
                  <p className="text-gray-600 dark:text-gray-400">React Force Graph</p>
