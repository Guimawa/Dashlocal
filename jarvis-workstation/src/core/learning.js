...
const learningLogs = [
  ...
  {
    source: 'BrainSystem',
    message: 'Optimisation de la stratégie de génération pour les composants TypeScript.',
  ...
  },
  {
    ...
    message: 'Découverte d\'un pattern récurrent : composants avec hooks personnalisés.',
