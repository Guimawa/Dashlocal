...
import { fetchGroqResponse, generatePrompt, validateGeneratedCode, formatCodeForPreview } from '../lib/groqClient';
...
export default function App() {
  ...
  const generateCode = useCallback(async (prompt: string, action?: string) => {
    setIsLoading(true);
    ...
    try {
      ...
      if (!validation.isValid) {
        addLog('Generated code has validation issues', 'warning', validation.errors.join(', '));
      }
  ...
  const updateSettings = useCallback((newSettings: Partial<AppContextType['settings']>) => {
